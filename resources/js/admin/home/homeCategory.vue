                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" cols="30" rows="4" class="form-control" v-model="category.desc"></textarea>
                                        </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn-save" v-if="showCreate" @click="saveCategory"> Save</button>
                                            <button class="btn-save" v-if="showUpdate"  @click="updateCategory"> update</button>
                                            ...
                                            <tr v-for="category in categories" :key="category.id">
                                                <td style= "color: #707070;" class="text-center">{{ category.id }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="edit_supplier" type="button"  @click="editCategory(category)">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </button>
                                                        <button class="btn_delete" type="button"  @click="deleteCategory(category)" >
   ...
   export default{
       ...
       methods:{
           ...
           saveCategory(){
            ...
            updateCategory(){
               var mythis = this;
               var edit = '/api/category/edit/' + this.category.id;
               axios.put(edit, this.category)
               .then(response =>{
                   alert(response.data.message);
                   this.category = {
                       name: "",
            ...
            deleteCategory(category){
                var remove = '/api/category/delete/' + category.id;
                axios.delete(remove)
                .then(response =>{
                    alert(response.data.message);
                    this.id=""
